...
export default function AdminLog() {
    ...
    function handlesubmit() {
        if (emailVerify && passwordVerify) {
            ...
            // Alert.alert("Please Fill Correctly");
            Toast.show({
                type:'error',
    ...
    return (
        ...
        <KeyboardAvoidingView behavior="padding" keyboardVerticalOffset={0} style={[Styles.container]}>
            <View style={{ alignItems: "center", justifyContent: 'center' }} >
                ...
                <Text style={Styles.text}>Sign to View Your Profile </Text>
                <Text style={[Styles.text, { marginTop: 0, fontSize: 20 }]}>Your profile data is Saved to your account</Text>
                ...
                <View style={[Styles.input]}>
                    ...
                    <TextInput style={{ fontSize: 20, fontWeight: 'bold', textAlign: 'center' }} placeholder="Enter Your Password"
                ...
                <Pressable onPress={() => navigation.navigate('Signup')}>
                    <Text style={[{ marginTop: 10, fontSize: 20 }]}>Didn't have an account? Create Account</Text>
